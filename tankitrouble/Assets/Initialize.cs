...
public class Initialize : MonoBehaviour
{
  ...
  void Start()
  {
    ...
    GameObject p1 = Instantiate(p1Fab, transform.parent.position + new Vector3(-7, -7, -1),
                                                transform.rotation);
    GameObject p2 = Instantiate(p2Fab, transform.parent.position + new Vector3(Random.Range(-7, 7), Random.Range(-7, 7), -1),
                                                transform.rotation);
